...
public:
    ...
    {
        if(0 != p && p->getType() == eJsonTypeBoolean)
        {
    ...
    {
        if(0 != p && p->getType() == eJsonTypeString)
        {
    ...
    {
        if(0 != p && p->getType() == eJsonTypeArray)
        {
